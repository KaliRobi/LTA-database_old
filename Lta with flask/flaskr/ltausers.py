...
from flaskr_p3.lta_database import get_users_db
from flaskr_p3.db_queries import record_counter
...
def login_to_app():
    ...
    if request.method == 'POST':        
        ...
        # elif not check_password_hash(user['password'], password):  no self password set yet
            error = 'Username or password is incorrect'
